...
@InputType()
class ScholarshipApplicationUpdateManyWithoutScholarshipsInput {
...
export { ScholarshipApplicationUpdateManyWithoutScholarshipsInput as ScholarshipApplicationUpdateManyWithoutScholarshipsInput };
