...
@InputType()
class ScholarshipProviderUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ScholarshipUpdateManyWithoutScholarshipProvidersInput,
  })
  @ValidateNested()
  @Type(() => ScholarshipUpdateManyWithoutScholarshipProvidersInput)
  @IsOptional()
  @Field(() => ScholarshipUpdateManyWithoutScholarshipProvidersInput, {
    nullable: true,
  })
  scholarships?: ScholarshipUpdateManyWithoutScholarshipProvidersInput;
}

export { ScholarshipProviderUpdateInput as ScholarshipProviderUpdateInput };
