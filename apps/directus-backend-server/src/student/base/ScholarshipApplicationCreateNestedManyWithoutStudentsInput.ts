...
@InputType()
class ScholarshipApplicationCreateNestedManyWithoutStudentsInput {
...
export { ScholarshipApplicationCreateNestedManyWithoutStudentsInput as ScholarshipApplicationCreateNestedManyWithoutStudentsInput };
